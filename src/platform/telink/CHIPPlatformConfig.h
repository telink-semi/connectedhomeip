...
#endif // defined(CONFIG_SOC_RISCV_TELINK_TL321X) || defined(CONFIG_SOC_RISCV_TELINK_TL323X)
...
#if !defined(CHIP_CONFIG_DEVICE_MAX_ACTIVE_DEVICES) && defined(CONFIG_CHIP_MAX_ACTIVE_DEVICES)

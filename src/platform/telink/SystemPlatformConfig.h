...
#define CHIP_SYSTEM_CONFIG_PLATFORM_PROVIDES_TIME 1
    ...
    defined(CONFIG_SOC_RISCV_TELINK_TL721X) || defined(CONFIG_SOC_RISCV_TELINK_TL521X) ||                                          \
...
// Reduce packet buffer pool size (default 15) to reduce ram consumption
    ...
    defined(CONFIG_SOC_RISCV_TELINK_TL721X) || defined(CONFIG_SOC_RISCV_TELINK_TL521X) || defined(CONFIG_SOC_RISCV_TELINK_W91)
